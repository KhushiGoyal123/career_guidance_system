...
export const Register = () => {
    ...
    const handleInput = (e) =>{
        ...
        setUser({
            ...user,
            [name]: value,  // passing name dynamically for value
        });
    };
                    ...
                    <div className="container grid grid-two-cols">
                        ...
                        <div className="registration-form">
                            ...
                            <div>
                                ...
                                <input 
                                    type="text" name="username" placeholder="username" id="username" required autoComplete="off" value={user.username} onChange={handleInput}
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input 
                                    type="number" name="phone" placeholder="phone" id="phone" required autoComplete="off" value={user.phone} onChange={handleInput}
                                />
                            </div>
                            <div>
